...
template <typename T> using MeasureMap = std::map<f32, T>;
...
struct SongInfo
{
    ...
    MeasureMap<f32> mBPMs;
    MeasureMap<f32> mStops;
    MeasureMap<SpeedValues> mSpeeds;
    MeasureMap<f32> mScrolls;

    MeasureMap<i32> mTickCounts;
    MeasureMap<TimeSignatureValues> mTimeSignatures;
    MeasureMap<std::string> mLabels;
    MeasureMap<i32> mCombos; // @TODO: Figure out how this works
    ...
    MeasureMap<std::string> mBGChanges; // @TODO: Figure out how this works   #BGCHANGES:;
